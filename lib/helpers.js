...
helpers.validateEmail = function(str, callback){
  if(str.indexOf('@') > -1 && str.indexOf('.') > -1){
    callback(true);
  } else {
    callback('Email format is incorrect. Must be in format "someone@domain." + suffix, (i.e. "com", "org", "edu", etc.');
  }
};

//@TODO will be used ot validate street address
helpers.validateStreetAddress = function(str, callback){
